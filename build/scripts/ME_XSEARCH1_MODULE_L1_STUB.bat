...
@rem ##########################################################################
@rem
@rem  ME_XSEARCH1_MODULE_L1_STUB startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and ME_XSEARC_H1_MODULE_L1_STUB_OPTS to pass JVM options to this script.
...
:fail
rem Set variable ME_XSEARC_H1_MODULE_L1_STUB_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%ME_XSEARC_H1_MODULE_L1_STUB_EXIT_CONSOLE%" exit 1
exit /b 1
